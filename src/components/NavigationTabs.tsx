...
export default function NavigationTabs() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    navigate(selectedTab); // Navigate to the selected tab's href
  };
    ...
    <div className="mb-5">
      <div className="sm:hidden">
        ...
        <select
          id="tabs"
          name="tabs"
          className="block w-full p-2 bg-gray-200 border-2 border-gray-300 rounded-md focus:border-blue-500 focus:ring-blue-500"
